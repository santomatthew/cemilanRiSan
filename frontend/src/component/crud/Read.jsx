        ...
        <div className="profile" >
            ...
            <Row style={{marginTop:'30px'}}>
                <Col lg="12" className="d-flex justify-content-start">
                    <p style={{fontSize:'50px',marginLeft:"30px"}}> List resep {username} <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-down-right-square-fill" viewBox="0 0 16 16">
